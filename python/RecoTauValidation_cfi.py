...
kinematicSelectedTauValDenominator = cms.EDFilter("GenJetSelector",
     src = cms.InputTag("dummy"),#cms.InputTag("objectTypeSelectedTauValDenominatorModule"),
...
efficiencies = cms.EDAnalyzer("DQMHistEffProducer",
    plots = plotPset    
)
