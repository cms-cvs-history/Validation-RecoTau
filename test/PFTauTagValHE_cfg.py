...
process.pfTauTagBothProngs = cms.EDAnalyzer("PFTauTagVal",
    ...
    PFTauDiscriminatorAgainstElectronProducer = cms.string('pfRecoTauDiscriminationHighEfficiencyAgainstElectron'),
    PFTauDiscriminatorAgainstMuonProducer = cms.string('pfRecoTauDiscriminationHighEfficiencyAgainstMuon'),
    #    string DataType = "QCD"
