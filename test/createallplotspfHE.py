...
if rootfilespftautagHE == 3:
    ...
    comparisonpath = comparisonpath + "/pftautagHE_" + comparisonrelease + "_OneProng_PFTAU.root"
    print rootfilename
    ...
    os.system("mv *png pftautagHE/OneProng")
    comparisonpath = ""
    comparisonpath = absolutepath.replace(releaseversion, comparisonrelease)
    rootfilename = "pftautagHE_" + releaseversion + "_ThreeProng_PFTAU.root"
    comparisonpath = comparisonpath + "/pftautagHE_" + comparisonrelease + "_ThreeProng_PFTAU.root"
    print rootfilename
